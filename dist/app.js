(function () {
  ...
  $('syntheticButton').addEventListener('click',()=>{setHistoricalOption(false);installReplay(T.synthetic(state.soc));invalidate();$('importStatus').textContent='Bundled synthetic replay restored.';});
